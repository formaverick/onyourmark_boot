...
insert into review (member_id, content, sentiment) values
(1, '만족해요. 좋은 선택이었던 것 같아요. 감사합니다!', 5),
(19, '솔직히 조금 실망했어요.', 2),
(26, '사이즈가 좀 크지만 가볍고 이쁘네요.', 4);

select * from review;
select * from review_img;

DELETE FROM review_img WHERE review_img_id > 0;
DELETE FROM review WHERE review_id > 0;
ALTER TABLE review AUTO_INCREMENT = 1;
ALTER TABLE review_img AUTO_INCREMENT = 1;